...
boolean CUSBDevice::Initialize (void)
{
    ...
    // コンフィグレーションディスクリプタ（8バイト短縮版）を仮設定
    ...
    // コンフィグレーションディスクリプタからインタフェースを取得する
